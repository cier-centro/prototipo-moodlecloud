...
var slideActivityContent = {
    ...
    options: [0,
        {
            title: `
                <p>¿Qué es perspectiva de género?</p>
            `,
            labels: [
                "<p><span class='letter'>a. </span>Significa que haya igual número de hombres y mujeres laborando en una isntitución.</p>",
                "<p><span class='letter'>b. </span>Significa asumir una mirada diferenciada para identificar desigualdades e inequidades que se dan por ser mujeres u hombres.</p>",
                "<p><span class='letter'>c. </span>Significa tener una mirada general de los problemas.</p>",
            ],
            correct: 2,
        },
    ],
