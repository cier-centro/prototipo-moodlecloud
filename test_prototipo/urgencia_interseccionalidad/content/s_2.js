            ...
            <main class="row justify-content-center content align-items-center h-100 pt-3">
                <div class="col-11 col-lg-10">
                    ...
                    <nav class="row align-items-center justify-content-evenly">
                        ...
                        <div class="col-5 col-md-3 col-lg-2">
                            <button onclick="goToSlide([],3)" class="btn btn-secondary rounded-pill shadow w-100 next" data-toggle="tooltip" title="Siguiente">Siguiente</button>
                        </div>
                    </nav>
                </div>
            </main>
...
var slideActivityContent = {
    ...
    options: [0,
        {
            title: `
                <p>¿Qué situación generó en Crenshaw su análisis sobre la interseccionalidad?</p>
            `,
            labels: [
                "<p><span class='letter'>a. </span>La problemática vivida por Emma Goldman.</p>",
                "<p><span class='letter'>b. </span>La problemática vivida por Emma DeGraffenreid.</p>",
                "<p><span class='letter'>c. </span>Su propia historia de vida.</p>",
            ],
            correct: 2,
        },
    ],
