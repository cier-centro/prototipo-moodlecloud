                ...
                <div class="col-11 col-lg-10">
                    <div class="row align-items-center justify-content-between bg-sec-light p-3 ">
                        ...
                        <div class="col-9 col-lg-10">
                            <p>Observa con atención el siguiente video de Crenshaw y luego responde las preguntas sugeridas.</p>
                            <p>Crenshaw, K. (2016) La urgencia de la interseccionalidad: <a href="https://www.ted.com/talks/kimberle_crenshaw_the_urgency_of_intersectionality?language=es#t-1116301" target="_blank">https://www.ted.com/talks/kimberle_crenshaw_the_urgency_of_intersectionality?language=es#t-1116301</a></p>
                            <p class="mb-0"><b>4 / 4</b></p>
                        </div>
                    </div>
                    ...
                    <nav class="row align-items-center justify-content-evenly">
                        <div class="col-5 col-md-3 col-lg-2">
                            <button onclick="goToSlide([],3)" class="btn btn-secondary rounded-pill shadow w-100 prev" data-toggle="tooltip" title="Anterior">Anterior</button>
                        </div>
                        <div class="col-5 col-md-3 col-lg-2">
                            <button onclick="goToSlide([],4)" class="btn btn-secondary rounded-pill shadow w-100 next d-none" data-toggle="tooltip" title="Siguiente">Siguiente</button>
                        </div>
                    </nav>
                </div>
            </main>
...
var slideActivityContent = {
    ...
    options: [0,
        {
            title: `
                <p>¿Si el nivel de violencia policial sobre mujeres negras reviste tanta gravedad en EEUU, por qué no se ha considerado como un problema complejo?</p>
            `,
            labels: [
                "<p><span class='letter'>a. </span>Porque no hay especialistas en comunicación que cubran las noticias y le den difusión.</p>",
                "<p><span class='letter'>b. </span>Porque no hay marcos de referencia para ver ese problema y reconocerlo en vías de transformarlo.</p>",
                "<p><span class='letter'>c. </span>Porque son hechos que no se denuncian debido a que recaen sobre mujeres de una clase social desfavorecida.</p>",
            ],
            correct: 2,
        },
    ],
