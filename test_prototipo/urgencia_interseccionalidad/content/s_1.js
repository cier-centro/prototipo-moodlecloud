...
var slideActivityContent = {
    ...
    options: [0,
        {
            title: `
                <p>De acuerdo con Kimberle Crenshaw, ¿qué es la interseccionalidad?</p>
            `,
            labels: [
                "<p><span class='letter'>a. </span>Es la conjunción de problemas en varios países del mundo.</p>",
                "<p><span class='letter'>b. </span>Es un conjunto de situaciones sociales injustas que recaen sobre hombres y mujeres de acuerdo con el país de procedencia.</p>",
                "<p><span class='letter'>c. </span>Es el solapamiento de variables que generan opresión hacia algunos grupos poblacionales, generando múltiples niveles de injusticia social.</p>",
            ],
            correct: 3,
        },
    ],
