...
var slideActivityContent = {
    ...
    options: [0,
        {
            title: `
                <p>¿Cuáles son las dos categorías de análisis más importantes que propone Crenshaw en el video?</p>
            `,
            labels: [
                "<p><span class='letter'>a. </span>La clase y la etnia.</p>",
                "<p><span class='letter'>b. </span>El género y la discapacidad.</p>",
                "<p><span class='letter'>c. </span>El género y la etnia.</p>",
            ],
            correct: 3,
        },
    ],
