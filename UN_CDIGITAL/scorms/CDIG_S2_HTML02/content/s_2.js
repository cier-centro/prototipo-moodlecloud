                ...
                <div class="col-11 col-lg-10 py-3">
                    <div class="row align-items-center bg-main rounded-top p-3">
                        <div class="col-12 text-center text-white">
                            <p class="mb-0">Selecciona todas las alternativas de medios o herramientas digitales que consideres que Sandra, Carolina, Julián y Sergio podrían emplear para organizar su trabajo en grupo y establecer acuerdos acerca de cómo distribuir las labores entre ellos.</p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center justify-content-evenly">
                    ...
                    <div class="col-11 col-md-7 pt-3 pt-md-0">
                        ...
                        <div class="text-start">
                            <p class="mb-0">Todas estas son herramientas que Sandra, Carolina, Julián y Sergio podrían emplear para coordinar sus actividades de trabajo en grupo, pues pueden intercambiar mensajes de texto, archivos, entre otros. </p>
                        </div>
                    </div>
                </div>
            `
