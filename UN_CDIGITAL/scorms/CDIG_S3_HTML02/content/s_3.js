            ...
            `
                <div class="row align-items-center justify-content-evenly">
                    ...
                    <div class="col-11 col-md-7 pt-3 pt-md-0">
                        ...
                        <p class="mb-0"> La opción correcta es la b, porque Pablo le muestra a Juan cómo hacerlo en términos sencillos y le pregunta primero qué sabe sobre el tema. </p>
                    </div>
                </div>
            `
        ],
