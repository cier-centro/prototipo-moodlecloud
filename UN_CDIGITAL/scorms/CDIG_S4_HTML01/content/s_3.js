                ...
                <div class="col-11 col-lg-10 py-3">
                    <div class="row align-items-center bg-main rounded-top p-3">
                        <div class="col-12 text-center text-white">
                            <p class="mb-0">El equipo debate la forma de integrar la información. Para ello, se plantean los aspectos más adecuados que debe tener la herramienta a utilizar para este propósito. A continuación, te presentamos los aportes hechos por los integrantes del equipo. Selecciona el más acertado.</p>
                        </div>
                    </div>
                ...
                <div class="row justify-content-evenly px-5">
                    ...
                    <div class="col-11 col-md-9 p-3">
                        ...
                        <div class="text-start">
                            <p class="mb-0">Herramientas como Drive, Dropbox u Office 365 te permiten cargar y compartir información, generarla, modificarla, tener control sobre los dominios de los archivos compartidos, permitiendo solo a los miembros del equipo interactuar con los aportes realizados por todos y contribuyen en la comunicación de los integrantes.</p>
                        </div>
                    </div>
                </div>
            `
...
`,
            labels: [
                '<ol type ="a" class="mb-0" start="1"><li>La herramienta debe permitir anexar archivos y enlaces, facilitar un rápido cargue del documento, compartirlo de manera segura, agregar comentarios y recuperar versiones del mismo.</li></ol>',
                '<ol type ="a" class="mb-0" start="2"><li>La herramienta debe permitir anexar archivos y enlaces, facilitar la comunicación desde el documento creado, compartirlo de manera abierta, agregar comentarios y recuperar versiones del mismo.</li ></ol>',
                '<ol type ="a" class="mb-0" start="3"><li>La herramienta debe permitir anexar archivos y enlaces, facilitar la comunicación desde el documento creado, compartirlo de manera segura, agregar comentarios y eliminar las versiones innecesarias.</li></ol>',
                '<ol type ="a" class="mb-0" start="4"><li>La herramienta debe permitir anexar archivos y enlaces, facilitar la comunicación desde el documento creado, compartirlo de manera segura, agregar comentarios y recuperar versiones del mismo.</li></ol>',
            ],
            correct: 4,
        },
    ],
