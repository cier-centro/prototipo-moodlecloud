                ...
                <div class="col-11 col-lg-10 py-3">
                    <div class="row align-items-center bg-main rounded-top p-3">
                        <div class="col-12 text-center text-white">
                            <p class="mb-0">Debido a que no se establecieron los parámetros para recopilar la información sobre el fertilizante problemático, Mateo y Felipe no tienen claros los datos que deben reunir. ¿Cuál es la mejor alternativa para resolver el problema?</p>
                        </div>
                    </div>
                ...
                <div class="row justify-content-evenly px-5">
                    ...
                    <div class="col-11 col-md-9 p-3">
                        ...
                        <div class="text-start">
                            <p class="mb-0">Esta opción plantea la resolución más efectiva para esta problemática, puesto que sintetiza los datos requeridos, centrando la información intercambiada por ellas y ellos para que sea más precisa, a la vez que permite optimizar los tiempos que cada una de las parejas tiene para esta actividad del trabajo.</p>
                        </div>
                    </div>
                </div>
            `
...
`,
            labels: [
                '<ol type ="a" class="mb-0" start="1"><li>Mariana y Victoria pueden generar un archivo con una tabla que les permita establecer la información, pues ellas pueden identificar mejor los elementos requeridos.</li></ol>',
                '<ol type ="a" class="mb-0" start="2"><li>Mateo y Felipe pueden generar un archivo con una tabla para establecer la información que tiene al alcance, pues ellos son quienes tienen acceso al fertilizante.</li ></ol>',
                '<ol type ="a" class="mb-0" start="3"><li>Mariana y Victoria pueden generar un archivo con una tabla que les permita establecer la información, pues ellas son quienes van a hacer las pruebas.</li></ol>',
                '<ol type ="a" class="mb-0" start="4"><li>Mateo y Felipe pueden generar un archivo con las dudas que tienen para que ellas las respondan y den las claridades frente a cada una de ellas.</li></ol>',
            ],
            correct: 1,
        },
    ],
