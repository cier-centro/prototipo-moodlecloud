                ...
                <div class="col-11 col-lg-10 py-3">
                    <div class="row align-items-center bg-main rounded-top p-3">
                        <div class="col-12 text-center text-white">
                            <p class="mb-0">Para esquematizar el mapa de resultados, antes de realizarlo de manera definitiva, Mariana y Victoria proponen utilizar Google Jamboard. A continuación, te presentamos algunas de las razones que pueden ayudar a justificar esta propuesta, selecciona la más acertada.</p>
                        </div>
                    </div>
                ...
                <div class="row justify-content-evenly px-5">
                    ...
                    <div class="col-11 col-md-9 p-3">
                        ...
                        <div class="text-start">
                            <p class="mb-0">Esta opción es la más acertada, puesto que integra los aspectos más relevantes de la herramienta sugerida, aspectos que los integrantes del equipo requieren en esta etapa del trabajo, pues les permitirá interactuar de manera simultánea y generar un esquema previo a la realización del mapa de resultados final, organizando y ajustando los elementos según los criterios de cada uno de los integrantes.</p>
                        </div>
                    </div>
                </div>
            `
...
`,
            labels: [
                '<ol type ="a" class="mb-0" start="1"><li>Esta es la opción más acertada, puesto que permite realizar un esquema final y luego compartirlo con los integrantes del equipo, para que cada quien haga los ajustes necesarios.</li></ol>',
                '<ol type ="a" class="mb-0" start="2"><li>Esta herramienta permite el trabajo simultáneo, integrar cualquier tipo de imagen, texto, nota y esquematizar, y estos son los elementos que se requieren para realizar esta parte del trabajo.</li ></ol>',
                '<ol type ="a" class="mb-0" start="3"><li>Esta herramienta permite el trabajo simultáneo, integrar cualquier tipo de imagen, texto, nota y esquematizar, y estos son los elementos que se requieren para establecer la organización de las actividades.</li></ol>',
                '<ol type ="a" class="mb-0" start="4"><li>Puesto que el equipo requiere manipular los elementos para esquematizar, textos, imágenes, datos, etcétera, de manera simultánea, es la opción más adecuada y sencilla.</li></ol>',
            ],
            correct: 2,
        },
    ],
