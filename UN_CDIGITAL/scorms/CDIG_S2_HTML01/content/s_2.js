                ...
                <div class="col-11 col-lg-10 py-3">
                    <div class="row align-items-center bg-main rounded-top p-3">
                        <div class="col-12 text-center text-white">
                            <p class="mb-0">¿Qué aplicaciones, plataformas y/o medios digitales serían pertinentes para que Tatiana contacte a su profesor?</p>
                        </div>
                    </div>
                        ...
                        <div class="col-11">
                            <div class="row check-activity align-items-center">
                                <div class="col-12 col-md-12">
                                    <div class="row">
                                        <div class="col-12 bg-inv-ultralight p-3 rounded" id="checkListQuestions"></div>
                                    </div>
                                    <div class="row mt-3">
                ...
                <div class="row align-items-center justify-content-evenly">
                    ...
                    <div class="col-11 col-md-7 pt-3 pt-md-0">
                        ...
                        <div class="text-start">
                            <ul>
                                <li>Chat de Moodle</li>
                                <li>Correo electrónico institucional</li>
                            </ul>
                            <p class="mb-0">Porque ambos son medios formales para dirigirse de manera asertiva al docente. Tatiana puede ingresar con su usuario de la universidad y escribir a la cuenta institucional del docente.</p>
                        </div>
                    </div>
                </div>
            `
        ...
        incorrectFeedback: [
            `
                <div class="row align-items-center justify-content-evenly">
                    ...
                    <div class="col-11 col-md-7 pt-3 pt-md-0">
                        <p class="text-purple-medium mb-0"><b>¡Vuelve a intentarlo!</b></p>
                    </div>
                </div>
            `
        ],
    ...
    options: [0,
        {
            title:
                `
                    <p class='mb-0'>Marque las opciones que considere correctas.</p>
                `
            ,
            labels: [
                "Chat de Moodle",
