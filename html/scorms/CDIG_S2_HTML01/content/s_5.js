    ...
    <div class="row h-100 main-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 text-center">
                            <div class="bg-main rounded-enunciate p-3 mb-3">
                                <p class="text-white mb-0">¿Cuál borrador de mensaje es el más apropiado para transmitir la necesidad de Tatiana?</p>
                            </div>
                        </div>
                    </div>
        ...
        <nav class="btns-nav-container mt-auto">
            <div class="col-12 py-3 d-flex justify-content-around">
                <button class="btn btns-nav prev" onclick="goToSlide([],6)" title="Atrás" data-toggle="tooltip">
                    Atrás
                </button>
                <button class="btn btns-nav next" onclick="goToSlide([],8)" title="Siguiente" data-toggle="tooltip">
                    Siguiente
                </button>
            </div>
        </nav>
