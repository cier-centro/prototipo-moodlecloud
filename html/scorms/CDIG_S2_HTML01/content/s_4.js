    ...
    <div class="row h-100 main-content">
        ...
        <nav class="btns-nav-container mt-auto">
            <div class="col-12 py-3 d-flex justify-content-around">
                <button class="btn btns-nav prev hidden" onclick="goToSlide([],3)" title="Atrás" data-toggle="tooltip">
                    Atrás
                </button>
                <button class="btn btns-nav next" onclick="goToSlide([],5)" title="Siguiente" data-toggle="tooltip">
                    Siguiente
                </button>
            </div>
        </nav>
